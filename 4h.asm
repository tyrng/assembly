...
; *************************************************************
; ERROR MESSAGE TEST
errorStr1   db "ERROR:ADDITION EXCEEDS 42949672.95!$",10,13,24
errorStr2   db "ERROR:INPUT OPERAND > SUPPORTED VALUE(42949672.95)!$",10,13,24
errorStr3   db "ERROR:UNSUPPORTED INPUT SYMBOL!$",10,13,24    
errorStr4   db "ERROR:MULTIPLICATION OR POWER EXCEEDS 429496.7295!$",10,13,24   
errorStr5   db "ERROR:SUBTRACTION RETURNS NEGATIVE VALUE!$",10,13,24          
errorStr6   db "ERROR:MULTIPLE DOTS IN INPUT OPERAND!$",10,13,24   
