...
; Input Variable ===========================================================            
    ...
    x dw -120                        ; starting point of 'x'
    times dw 800                      ; this is a skalar y=kx, which 
    Inv_x dw 1                      ; 1/x
...
_Exponential proc  
    ...
    ; do compare with div and mul                
    div divExp                  ; for a^(x/n), this will extend the graph 
    ;mul mulExp                  ; for a^(nx)  double the X, add soon if needed
