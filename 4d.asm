...
GradientTerm:    
    ...
    loop GradientTerm           ; if enters more than 1 then auto out
...
BaseTerm:                         
    ...
    mov bx, -1                  ; negate iBase later
    jmp BaseTerm                ; jump back to get number
    
    noNegBase:
    
        cmp al, 'X'
        je nextTerm             ; next will checks if ^ is entered  
